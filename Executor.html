...
<head>
    ...
    <style>
        ...
        .menu-toggle {
            ...
            cursor: pointer;
            z-index: 10;
            border-radius: 10px; /* Rounded corners for the entire hamburger */
            padding: 5px; /* Space around the hamburger icon */
            background-color: transparent; /* Transparent background for the hamburger */
        }
        ...
        .menu-toggle div {
            ...
            margin: 4px 0;
            border-radius: 2px; /* Rounded edges for the individual bars */
    ...
    <nav class="menu-overlay" id="menu">
        ...
        <div class="social-icons">
            ...
            <a href="https://discord.gg/Hk9h8vnZ7w" target="_blank">
                <img src="https://media.discordapp.net/attachments/1235374443413635115/1322719710835638313/IMG_1348.png?ex=6771e63a&is=677094ba&hm=b584940836f5bfef6e2333f84f6b1331a856eb0ef8c0852d3d412dd41ed615eb&=&width=832&height=468" 
                     alt="Discord">
            </a>
        </div>
    </nav>
